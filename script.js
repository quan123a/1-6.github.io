...
function tapLove(id) {
  ...
  if (loveTaps.size === 4) {
    Swal.fire({
      ...
      typeWriterEffect(
        `Chúc ${userName} của tớ 1/6 thật vui vẻ như một đứa trẻ, nhưng được tớ yêu như một nữ hoàng 👑. Dù cậu có lớn bao nhiêu thì trong tim tớ, cậu vẫn là công chúa bé bỏng cần được cưng chiều mỗi ngày.LOVE YOU!💘`,
        'loveMsg',
        () => {
          const fromTag = document.createElement("div");
          fromTag.id = 'fromTag';
          fromTag.textContent = "From: Văn Công Quân(QuânDz)";
